...
void RoundOverMenu::draw(int winW, int winH) const {
    ...
    glColor3f(1, 1, 1);
    DrawTextCentered(m_cx, m_cy + 110,
        m_success ? "MISSION SUCCESS" : "MISSION FAILED",
        GLUT_BITMAP_HELVETICA_18);

    DrawTextCentered(m_cx, m_cy + 80, m_stat1.c_str(), GLUT_BITMAP_HELVETICA_12);
    DrawTextCentered(m_cx, m_cy + 60, m_stat2.c_str(), GLUT_BITMAP_HELVETICA_12);
